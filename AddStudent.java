...
public class AddStudent extends JFrame implements ActionListener{
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "CSE", "IT", "ME", "Civil", "Automobile", "EEE", "Other" }));
	...
	comboBox_3.setModel(new DefaultComboBoxModel(
			new String[] { "B.Tech","B.E", "M.Tech", "MBA", "BBA", "BCA", "B.Sc", "M.Sc", "B.Com", "M.Com" }));
